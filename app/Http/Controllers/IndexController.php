...
//        }
    ...
    public function taglist($id)
    {
        ...
        $questions = Tag::findOrFail($id)->questions()->paginate(5, ['*'], 'taglist_page');
    ...
    public function catlist(Request $request, $id)
    {
        ...
        $hotted_questions = Cat::findOrFail($id)->questions()->orderBy('votes', 'desc')->paginate(5, ['*'], 'hotted_page');
        $latest_questions = Cat::findOrFail($id)->questions()->orderBy('updated_at', 'asc')->paginate(5, ['*'], 'latest_page');
